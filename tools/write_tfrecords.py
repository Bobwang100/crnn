...
def init_args():
    ...
    parser.add_argument('-d', '--dataset_dir', type=str, default='../data/images/', help='The origin synth90k dataset_dir')
    parser.add_argument('-s', '--save_dir', type=str, default='../data/',help='The generated tfrecords save dir')
